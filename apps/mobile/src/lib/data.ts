 ...
 */
const TEAMS = [
  { code: 'MEX', name: 'Mexico',           flag: '🇲🇽', group: 'Concacaf' },
  { code: 'RSA', name: 'South Africa',     flag: '🇿🇦', group: 'Africa' },
  { code: 'KOR', name: 'South Korea',      flag: '🇰🇷', group: 'Asia' },
  { code: 'CAN', name: 'Canada',           flag: '🇨🇦', group: 'Concacaf' },
  ...
  { code: 'HAI', name: 'Haiti',            flag: '🇭🇹', group: 'Concacaf' },
  { code: 'SCO', name: 'Scotland',         flag: '🏴', group: 'Europe' },
  ...
  { code: 'CUW', name: 'Curaçao',          flag: '🇨🇼', group: 'Concacaf' },
  ...
  { code: 'CPV', name: 'Cape Verde',       flag: '🇨🇻', group: 'Africa' },
  ...
  { code: 'JOR', name: 'Jordan',           flag: '🇯🇴', group: 'Asia' },
  { code: 'POR', name: 'Portugal',         flag: '🇵🇹', group: 'Europe' },
  { code: 'UZB', name: 'Uzbekistan',       flag: '🇺🇿', group: 'Asia' },
  ...
  { code: 'SWE', name: 'Sweden',           flag: '🇸🇪', group: 'Europe' },
  { code: 'TUR', name: 'Türkiye',          flag: '🇹🇷', group: 'Europe' },
  { code: 'CZE', name: 'Czech Republic',   flag: '🇨🇿', group: 'Europe' },
  { code: 'IRQ', name: 'Iraq',             flag: '🇮🇶', group: 'Asia' },
  { code: 'COD', name: 'DR Congo',         flag: '🇨🇩', group: 'Africa' },
]
...
export const ALBUM: AlbumGroup[] = [
  ...
  // 3. Stars — 20 player slots (GOAT/CRACK/STAR tiers)
  {
    ...
    prefix: 'STAR',
    name: 'Stars',
    subtitle: '20 players · GOAT / CRACK / STAR',
    emoji: '⭐',
    kind: 'legend',
